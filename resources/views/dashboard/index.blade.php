...
@section('container')
    <div class="container-fluid" id="dashboard">
        <div class="row">
            <div class="col-md">
                ...
                <div class="row gap-2 mb-2" id="counter">
                    ...
                    <div class="col-lg-4 py-3 border rounded bg-success bg-opacity-25">
                        <div class="row">
                            <div class="col">
                                <h3><i class="bi-cash me-2"></i>Earns</h3>
        ...
        <div class="row gap-2 mb-1">
            ...
            <div class="col-lg col-md border rounded py-2" id="product">
        ...
        <div class="row gap-2">
            <div class="col-lg border rounded p-2 me-2 my-1" id="lastScannedTicket">
                ...
                <div class="row gap-2 px-2 mb-2">
                    <div class="col-sm text-center rounded py-2 bg-gradient" style="background: #ff86d1;">
                        <h6>Ticket Bermain</h6>
                        <h5 class="bg-white py-1 rounded">{{ $tiketBermain }}</h5>
                    </div>
                    <div class="col-sm text-center rounded py-2 bg-gradient" style="background: #6bbcff;">
                        <h6>Ticket Pendamping</h6>
                        <h5 class="bg-white py-1 rounded">{{ $tiketPendamping }}</h5>
                    </div>
                    <div class="col-sm text-center rounded py-2 bg-gradient" style="background: #ba7dff;">
