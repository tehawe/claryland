...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-5 me-2">
            <h3 class="border-bottom pb-3">New Order (#{{ $invoice }})</h3>
            <form action="{{ route('orders.store', ['order' => $invoice]) }}" method="POST">
                ...
                <div class="my-3 mb-3 d-flex justify-content-center">
                    ...
                    <button class="btn btn-primary btn-sm"><i class="bi-check-square me-1"></i>Order Now</button>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('orders.create', ['order' => $pendingOrder->invoice]) }}"><i class="bi-trash me-1"></i>Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
