        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row p-2 mb-3">
                    ...
                    <div class="col text-center border border-info rounded"><span class="d-block fs-3"><i class="bi-person my-1"></i></span>{{ $customer['name'] }}</div>
                    <div class="col text-center border border-info rounded mx-1"><span class="d-block fs-3"><i class="bi-telephone my-1 me-1"></i></span>{{ $customer['contact'] }}</div>
                    <div class="col text-center border border-info rounded"><span class="d-block fs-3"><i class="bi-envelope-at my-1 me-1"></i></span>{{ $customer['email'] }}</div>
                </div>
